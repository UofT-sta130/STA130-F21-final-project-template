...
author: "Student name(s) and team name (exactly as it appears on Quercus, if applicable)"
...
The examples are shown with the `cars` dataset, which is NOT your project dataset.
